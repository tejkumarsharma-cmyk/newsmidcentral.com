export const siteIdentity = {
  ...
  tagline: process.env.NEXT_PUBLIC_SITE_TAGLINE || 'UK\'s #1 Press Media Distribution Service',
  description:
    process.env.NEXT_PUBLIC_SITE_DESCRIPTION ||
    'Professional press media distribution service helping businesses reach media outlets and maximize their PR impact across the UK.',
